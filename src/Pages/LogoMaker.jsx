  ...
  return (
    ...
    >
      ...
      {!upgrade ? (
        <>
          <div
            className={`editor ${active && "active"} w-full h-full overflow-y-scroll`}
          >
            <button
            ...
            <div className="w-full mt-20 grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 md:gap-y-10 sm:px-8 px-0">
              <div className="w-full px-2 md:my-0 my-10">
                <div className="h-full w-full bg-gray-950 p-6 rounded-2xl flex flex-col relative overflow-hidden">
                  ...
                  <Link className="flex font-bold items-center text-gray-900 mt-4 bg-white border-2 justify-between hover:text-white py-2 px-4 w-full focus:outline-none hover:bg-gray-900 transition-all duration-300 rounded-md">
                    Get For Month
                    <FaArrowRight />
                  </Link>
